        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="mb-4 inline-flex items-center gap-2">
              <span className="font-[var(--font-accent)] text-2xl font-bold text-accent">
                City
              </span>
          ...
          <div>
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 text-sm text-white/60 transition-colors hover:text-accent"
            >
