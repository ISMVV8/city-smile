const points = [
  {
    title: "Maîtriser les techniques de blanchiment LED",
    description: "Apprenez à utiliser les équipements professionnels et les protocoles de traitement.",
    icon: (
  ...
  {
    title: "Comprendre la science du sourire",
    description: "Anatomie dentaire, colorimétrie et chimie des agents de blanchiment.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Gérer votre activité de A à Z",
    description: "Business plan, cadre légal, gestion clientèle et stratégie marketing.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Exercez-vous en conditions réelles sous supervision pour une maîtrise totale.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Obtenir votre certification",
    description: "Recevez un certificat reconnu attestant de vos compétences professionnelles.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
